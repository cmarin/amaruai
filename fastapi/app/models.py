from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, Table, Text, UUID, BigInteger, TIMESTAMP, DateTime, Float
...
class Workflow(Base):
    ...
    asset_selection_config = Column(JSONB, nullable=True)
