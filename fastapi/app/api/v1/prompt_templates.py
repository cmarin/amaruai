...
from app import crud, schemas, models  # Add models to the import
from app.database import get_db

router = APIRouter()

@router.post("/prompt_templates/", response_model=schemas.PromptTemplate)
...
@router.get("/prompt_templates/", response_model=List[schemas.PromptTemplate])
...
@router.get("/prompt_templates/{prompt_template_id}", response_model=schemas.PromptTemplate)
...
@router.put("/prompt_templates/{prompt_template_id}", response_model=schemas.PromptTemplate)
...
@router.delete("/prompt_templates/{prompt_template_id}", response_model=schemas.PromptTemplate)
