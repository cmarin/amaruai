...
export interface PromptTemplateOption extends Pick<PromptTemplate, 'id' | 'title' | 'prompt' | 'default_persona_id' | 'default_chat_model_id' | 'default_persona_id' | 'default_chat_model_id'> {}
